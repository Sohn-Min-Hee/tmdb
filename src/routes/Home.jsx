...
const Home = () => {
    ...
    const getMovies = async () => {
        try{
            ...
            const rec=await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=${apikey}&language=ko) `) /* 추천영화 */
            ...
            <div className="recommend">
                ...
                <div className="search">
                    <div className="searchBox">
                        ...
                        <button className="searchBtn" onClick={search}><IoSearch/></button>
                    </div>
                </div>
