        ...
        <div className='footer'>
            <div className="innerFooter">
                ...
                <div className="footerNav">
                    ...
                    <ul>
                        <li>참여하기</li>
                        <li><Link to="">기여 지침서</Link></li>
                        <li><Link to="">새 영화 추가</Link></li>
                        <li><Link to="">새 TV 프로그램 추가</Link></li>
                    </ul>
                    <ul>
                        <li>커뮤니티</li>
                        <li><Link to="">가이드라인</Link></li>
                        <li><Link to="">토론 내역</Link></li>
                        <li><Link to="">기여 랭킹</Link></li>
                        <li><Link to="">토론 지원</Link></li>
                    </ul>
                    <ul>
                        <li>법적사항</li>
